...
<div class="container" style="margin-top: 20px !important;">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header" style="color: #2b7e75; background-color: #cdebe8">{{ __('Přihlásit se') }}</div>
                        ...
                        <div class="form-group row">
                            <div class="col-md-6 offset-md-4">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" style="color: #2b7e75;" for="remember">
                                        {{ __('Pamatovat uživatele') }}
                                    </label>
                                </div>
                            </div>
                        </div>
